  ...
  head: () => ({
    meta: [
      ...
      { title: "HelixAgent — AI Development Command Center" },
      {
        name: "description",
        content:
          "Desktop-class AI development command center: multi-agent orchestration, editor, terminal, git and model management.",
      },
      { property: "og:title", content: "HelixAgent — AI Development Command Center" },
      {
        property: "og:description",
        content:
          "Multi-agent orchestration, editor, terminal, git and model management in one premium dark workspace.",
      },
